 ...
 * mismo patrón que PanelImportArticuloDimensiones.jsx: subir archivo,
 * previsualizar con reporte de rechazadas ANTES de aplicar, aplicar en lote.
 *
 * Contenido de una pestaña de PanelImportMigracion.jsx.
 */
export default function PanelImportZonasPick({ sesion }) {
  ...
  async function aplicar() {
    ...
    setError('');
    try {
      await zonasPickService.guardarLote(previa.validas, sesion.usuarioId);
